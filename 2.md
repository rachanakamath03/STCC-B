...
These notes introduce core Unix concepts required for handling biological
sequence files (FASTA/FASTQ) in bioinformatics pipelines.

---

##  Files, Directories, and Naming Patterns
...
---
 Why This Matters for Bioinformatics Pipelines
